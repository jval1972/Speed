...
uses
  ...
  r_col_al in 'Speed\r_col_al.pas',
  r_col_av in 'Speed\r_col_av.pas',
  r_col_fz in 'Speed\r_col_fz.pas',
  r_col_l in 'Base\r_col_l.pas',
  r_col_ms in 'Speed\r_col_ms.pas',
  r_col_sk in 'Speed\r_col_sk.pas',
  r_col_tr in 'Base\r_col_tr.pas',
  r_column in 'Speed\r_column.pas',
