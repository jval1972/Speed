...
var
  ...
  old_transmissiontype: integer = TT_AUTOMATIC;
...
begin
  ...
  begin
    ...
    transmissiontype := old_transmissiontype;
    numlaps := old_numlaps;
...
begin
  ...
  if gamekeydown[key_gearup] or (usejoystick and joybuttons[joygearup]) then
    cmd.buttons2 := cmd.buttons2 or BT2_GEARUP
  else if gamekeydown[key_geardown] or (usejoystick and joybuttons[joygeardown]) then
    cmd.buttons2 := cmd.buttons2 or BT2_GEARDOWN;
...
begin
  ...
  old_transmissiontype := transmissiontype;
  old_numlaps := numlaps;
